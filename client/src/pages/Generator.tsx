  ...
  return (
    <div className="min-h-screen text-white p-6 md:p-12 mt-28">
      ...
      <form onSubmit={handleGenerate} className="max-w-4xl mx-auto mb-40" >
        ...
        your model and product images to generat stunning UGC,
          ...
          <div className="w-full">
            <div className="mb-4 text-gray-300">
              ...
              <input type="text" id="name" value={name} onChange={(e) => setName(e.target.value)} placeholder="Name Your Project" required
                className="w-full bg-white/3 round-lg border-2 p-4 text-sm
            ...
            <div className="mb-4 text-gray-300">
              ...
              <div className="flex gap-3">
                <RectangleVerticalIcon onClick={() => setAspectRatio('9:16')} className={`p-2.5 size-13 bg-white/6 rounded transition-all
            ring-2 ring-transparent cursor-pointer ${aspectRatio === '9:16' ? 'ring-violet-500/50 bg-white/10' : ''} `} />
                <RectangleHorizontalIcon onClick={() => setAspectRatio('16:9')} className={`p-2.5 size-13 bg-white/6 rounded transition-all
